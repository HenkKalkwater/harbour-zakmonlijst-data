# Data for harbour-zakmonlijst
This data is originally from the [PokéAPI project](https://github.com/PokeAPI/pokeapi), licenced under the BSD-3 Clause. The database for the harbour-zakmonlijst can be generated by running `make-database.py`.
